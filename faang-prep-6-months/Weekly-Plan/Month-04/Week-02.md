...
**Objective:**  
Solve advanced graph problems like topological sort, strongly connected components (SCC), and graph dynamic programming. Connect graph DP to problem-solving patterns.
...
**Dependencies:** BFS/DFS (Week 13), Graph representation (adjacency list)  
...
**Dependencies:** Day 1 (Topological Sort), Queues, Graph traversal  
...
**Dependencies:** DFS (Week 13), topological sort (Days 1–2), Stack usage  
...
**Dependencies:** Topological sort, DAG knowledge (Days 1–2), DP concepts (Weeks 10–12)  
...
**Dependencies:** Day 4 (graph DP intro), DP memoization & tabulation  
...
**Dependencies:** Days 1–5 (all advanced graph topics)  
