...
**Objective:**  
Understand the fundamentals of Dynamic Programming (DP), learn memoization vs tabulation, and start solving classic DP problems step-by-step. Link DP thinking to real-world optimization problems.
...
**Dependencies:** Recursion (Week 6 trees), Problem-solving patterns (Week 3–8)  
...
**Dependencies:** Day 1 DP introduction, Recursion depth (Week 2)  
...
**Dependencies:** Memoization patterns (Day 2), Arrays (Week 3)  
...
**Dependencies:** Tabulation & memoization (Days 2–3), Arrays/strings (Week 3)  
...
**Dependencies:** Days 1–4 DP concepts, Problem-solving mindset (Week 3–8)  
