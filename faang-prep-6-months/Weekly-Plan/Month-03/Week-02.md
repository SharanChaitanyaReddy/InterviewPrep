...
**Objective:**  
Deepen understanding of Dynamic Programming, learn advanced DP patterns and problem-solving techniques, focus on optimization and real-world application, and prepare for medium-hard FAANG-style DP problems.
...
**Dependencies:** Week 9 (DP fundamentals), Arrays & Strings (Week 3)  
...
**Dependencies:** Day 1 advanced DP patterns, Arrays (Week 3)  
...
**Dependencies:** Weeks 7–9 (trees, graphs, DP basics), Problem-solving strategies (Week 3)  
...
**Dependencies:** Week 8 (graphs), Week 9–10 (DP fundamentals & patterns)  
...
**Dependencies:** Days 1–4 (Advanced DP & optimization patterns)  
