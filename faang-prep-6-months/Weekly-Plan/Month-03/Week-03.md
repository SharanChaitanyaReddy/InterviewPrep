...
**Objective:**  
Understand Greedy Algorithms and Backtracking patterns, learn when to apply greedy vs DP vs backtracking, and solve problems efficiently with optimal choices and pruning.
...
**Dependencies:** Arrays & sorting (Weeks 3–4), Problem-solving strategies (Week 3)  
...
**Dependencies:** Day 1 (greedy basics), Arrays, sorting, prefix sums  
...
**Dependencies:** Recursion fundamentals (Week 7), Problem-solving strategies (Week 3)  
...
**Dependencies:** Day 3 (backtracking intro), 2D arrays and grid traversal (Week 8)  
...
**Dependencies:** Days 1–4 (Greedy & Backtracking concepts and coding)  
